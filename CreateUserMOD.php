...
//        echo __FILE__;
        try{
            ...
            if($boola){
                $_SESSION['communicate'] = 'OK / '.'User like <span class=red>"'.$login.'"</span> created';
...
/*               if(!is_dir('../svenska/'.$userFolder)){
                ...
                $_SESSION['communicate'] = 'User like <span class=red>"'.$login.'"</span> was NOT created /'.mysql_error();
            }
        } catch (Exception $ex) {
            $error = $ex->getMessage();
